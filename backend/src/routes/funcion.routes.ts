...
import { crearFuncion, eliminarFuncion, copiarSemanaFunciones } from '../controllers/funcionCrud.controller.js';
...
router.post('/copiar-semana', authMiddleware, requireRoles('ADMINISTRADOR'), copiarSemanaFunciones);
